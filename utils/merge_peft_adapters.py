...
if __name__ == '__main__':
    merge_peft_adapters(adapter_dir=f"/home/fanqi/llm_simulation/models/SFT/result_comm_0", output_path=f"/home/fanqi/llm_simulation/models/SFT/sft_merged_ckp_0")