...
if __name__ == '__main__':
    ...
    for epoch in range(0, training_epoch):
        ...
        ''' DPO training '''
        dpo_model_path = f"/home/fanqi/llm_simulation/models/DPO/baselines/wo_adv_merged_ckp_{epoch}"
        if not os.path.exists(dpo_model_path):
            ...
            DPO_trainer.train()
            DPO_trainer.save_model(f"/home/fanqi/llm_simulation/models/DPO/baselines/wo_adv_result_{epoch}")
            ...
            # update generator
            merge_peft_adapters(adapter_dir=f"/home/fanqi/llm_simulation/models/DPO/baselines/wo_adv_result_{epoch}", output_path=dpo_model_path)
