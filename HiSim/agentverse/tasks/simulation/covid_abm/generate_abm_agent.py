...
# 加载user.json文件
with open('/home/fanqi/llm_simulation/data/raw_data/community_5/user.json', 'r', encoding='utf-8') as f:
    users = json.load(f)
...
# 输出到YAML文件
with open('/home/fanqi/llm_simulation/HiSim/agentverse/tasks/simulation/covid_abm/abm_model.yaml', 'w', encoding='utf-8') as f:
